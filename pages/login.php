          ...
          <div class="md:max-w-md w-full px-4 py-4">
            <form>
              <div class="mb-12">
                ...
                <p class="text-sm mt-4 text-gray-800">Don't have an account <a href='<?= ROOT_DIR ?>pages/register.php' class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
              </div>
