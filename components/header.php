<?php
define('ROOT_DIR', '/johnc/php-examples/');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header class='font-[sans-serif] min-h-[60px] tracking-wide relative z-50'>
      <section class="bg-slate-700 min-h-[40px] px-4 py-2 sm:px-10 flex items-center max-sm:flex-col">
        <button type="button" class="text-white text-sm">
          <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="bg-slate-950" class="mr-3 inline-block"
        ...
        <button type="button" class="text-white text-sm max-sm:my-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="bg-slate-700" class="mr-3 inline-block"
      ...
      <div class='flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-slate-700 lg:gap-y-4 gap-y-6 gap-x-4'>
        <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui-white.svg" alt="logo" class='sm:w-[140px] w-[130px]' />
        </a>
